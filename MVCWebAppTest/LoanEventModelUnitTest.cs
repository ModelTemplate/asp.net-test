...
namespace MVCWebAppTest
{
    public class LoanEventModelUnitTest
    {
        ...
        [Theory]
        [InlineData(1, "Joe Smith", "2020-8-20", "2020-8-25", "2020-8-25")]
        [InlineData(2, "Mary Jane", "2021-12-5", "2022-1-1", "2020-1-3")]
        public void AllParamTest(int loanerId, string borrowerName, string loanDate,
            string dueDate, string returnDate)
        {
            LoanEvent loan = new LoanEvent(loanerId, borrowerName, DateTime.Parse(loanDate),
